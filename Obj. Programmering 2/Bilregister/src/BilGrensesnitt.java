...
public class BilGrensesnitt {
	...
	public void lesFiler() {
		try {
			bilkontroll.lesFil(bilfil,eierfil,postfil);
		}catch(Exception e){JOptionPane.showMessageDialog(null,e.getMessage());}
	}
	
	public void skrivFiler() {
		try{
			bilkontroll.skrivFil(bilfil, eierfil,postfil);
		}catch(Exception e){JOptionPane.showMessageDialog(null,e.getMessage());}
	}
	...
	public void lesPostadresser() {
		try {
			bilkontroll.lesPostnummer(postfil);
		}catch(Exception e){JOptionPane.showMessageDialog(null,e.getMessage());}
	}
	...
	public void regBil() {
		...
		Person p = bilkontroll.finnEier(enavn);
		JOptionPane.showMessageDialog(null, p.toString());
		bilkontroll.regBil(regnr, merke, p);
	}
