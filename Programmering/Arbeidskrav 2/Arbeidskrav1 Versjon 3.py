...
def slettstudent():
    ...
    while slettstudent_fortsette == True:
        ...
        # Hvis studenten eksisterer i student.txt
        if finnes == True:
            student_fil.close()

            # Sjekker eksamensresultat.txt for om studenten har eksamenskarakter
            har_resultat = False
            ...
            # Hvis studenten har karakter i eksamensresultat.txt kan ikke studenten slettes.
            ...
            # Hvis studenten ikke har resultat(er) så slettes studenten fra student.txt
            else:
                eksamen_fil.close()

                print('------------------------------')
                print('Du oppga studentnr',studentnr_input,'.')
                print('Denne studenten har blitt slettes.')
                print('------------------------------')
