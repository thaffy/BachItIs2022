...
# Vi bør sikre oss at det bare er metodene til objektet som kan endre/aksesere attributtene/instansevariablene
...
class Mynt:
    ...
    def __init__(self):
        self.sideopp = input('Hvilken side er opp før første kast? ')
...
def main():
    ...
    for antall_ganger in range(1,antall_kast+1,1):
        ...
        # Her komm den nye "jukse-koden"
        # Uansett hva som blir resultatet av kast-metoden overstyrer vi resultatet til å bli f.eks krone
        min_mynt.sideopp='Krone'
        print('Resultatet av kast nr',antall_ganger,'ble manipulert til',min_mynt.hent_sideopp())
